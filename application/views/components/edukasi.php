<?php
// Data tiruan (mock data) untuk buku-buku Edukasi
$books = [
    [
        'title' => 'Fisika Dasar Edisi 7',
        'author' => 'Halliday & Resnick',
        'price' => 150000,
        'rating' => 5,
        'image' => 'https://images.unsplash.com/photo-1532094349884-543bc11b234d?q=80&w=200&h=300&auto=format&fit=crop'
    ],
    [
        ...
        'price' => 65000,
        'rating' => 5,
        'image' => 'https://images.unsplash.com/photo-1503676260728-1c00da094a0b?q=80&w=200&h=300&auto=format&fit=crop'
    ],
    [
        ...
        'price' => 200000,
        'rating' => 4,
        'image' => 'https://images.unsplash.com/photo-1509228468518-180dd4864904?q=80&w=200&h=300&auto=format&fit=crop'
    ],
    [
        'title' => 'Guru Aini',
        ...
        'price' => 85000,
        'rating' => 5,
        'image' => 'https://images.unsplash.com/photo-1497633762265-9d179a990aa6?q=80&w=200&h=300&auto=format&fit=crop'
    ],
    [
        'title' => 'Biologi Edisi Kedelapan',
    ...
    [
        ...
        'price' => 55000,
        'rating' => 4,
        'image' => 'https://images.unsplash.com/photo-1456513080510-7bf3a84b82f8?q=80&w=200&h=300&auto=format&fit=crop'
    ]
];
?>
...
<head>
    ...
    <title>Kategori Edukasi - E-PUSTAKA</title>
...
<body class="bg-epustaka-bg font-sans text-gray-800">
    ...
    <!-- Navbar Sederhana (Referensi Gambar 1) -->
    ...
    <main class="container mx-auto px-4 md:px-12 py-8 flex flex-col md:flex-row gap-8">
        ...
        <!-- Sidebar Filter (Referensi Gambar 2) -->
            ...
            <div class="mb-6">
                ...
                <div class="pl-4 flex flex-col gap-2 text-sm text-gray-600">
                    ...
                    <label class="flex items-center gap-2 cursor-pointer">
                        ...
                        <span class="font-medium text-epustaka-green">Edukasi</span>
                    </label>
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="radio" name="subkategori" class="text-epustaka-green focus:ring-epustaka-green">
                        <span>Agama</span>
        ...
        <!-- Grid Produk (Gabungan Layout Gbr 2 & Styling Gbr 1) -->
        <section class="w-full md:w-3/4">
            <div class="mb-6 flex justify-between items-center">
                <h2 class="text-2xl font-bold text-gray-800">Koleksi Edukasi</h2>
