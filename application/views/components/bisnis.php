<?php
// Data tiruan (mock data) untuk buku-buku Bisnis & Ekonomi
$books = [
    [
        ...
        'price' => 125000,
        'rating' => 5,
        'image' => 'https://images.unsplash.com/photo-1612178537253-bccd437b730e?q=80&w=200&h=300&auto=format&fit=crop'
    ],
    [
        ...
        'price' => 95000,
        'rating' => 5,
        'image' => 'https://images.unsplash.com/photo-1592492152222-d3c2803b966c?q=80&w=200&h=300&auto=format&fit=crop'
    ],
    [
        'title' => 'Atomic Habits',
        'author' => 'James Clear',
    ...
    [
        ...
        'price' => 90000,
        'rating' => 5,
        'image' => 'https://images.unsplash.com/photo-1553729459-efe14ef6055d?q=80&w=200&h=300&auto=format&fit=crop'
    ],
    [
...
<head>
    ...
    <title>Kategori Bisnis & Ekonomi - E-PUSTAKA</title>
    ...
    <main class="container mx-auto px-4 md:px-12 py-8 flex flex-col md:flex-row gap-8">
            ...
            <div class="mb-6">
                ...
                <div class="pl-4 flex flex-col gap-2 text-sm text-gray-600">
                    ...
                    <label class="flex items-center gap-2 cursor-pointer">
                        ...
                        <span class="font-medium text-epustaka-green">Bisnis & Ekonomi</span>
                    </label>
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="radio" name="subkategori" class="text-epustaka-green focus:ring-epustaka-green">
        ...
        <section class="w-full md:w-3/4">
            <div class="mb-6 flex justify-between items-center">
                <h2 class="text-2xl font-bold text-gray-800">Koleksi Bisnis & Ekonomi</h2>
