<?php
// Data tiruan (mock data) untuk buku-buku fiksi
$books = [
    [
        'title' => 'Dunia Sophie',
        ...
        'price' => 70000,
        'rating' => 5,
        'image' => 'https://images.unsplash.com/photo-1544947950-fa07a98d237f?q=80&w=200&h=300&auto=format&fit=crop'
    ],
    [
    ...
    [
        ...
        'price' => 75000,
        'rating' => 5,
        'image' => 'https://images.unsplash.com/photo-1512820790803-83ca734da794?q=80&w=200&h=300&auto=format&fit=crop'
    ],
    [
        ...
        'price' => 88000,
        'rating' => 4,
        'image' => 'https://images.unsplash.com/photo-1543002588-bfa74002ed7e?q=80&w=200&h=300&auto=format&fit=crop'
    ],
    [
        'title' => 'Pulang',
        ...
        'price' => 90000,
        'rating' => 5,
        'image' => 'https://images.unsplash.com/photo-1589998059171-989d887dda1e?q=80&w=200&h=300&auto=format&fit=crop'
    ]
];
?>
...
<head>
    ...
    <title>Kategori Fiksi - E-PUSTAKA</title>
    ...
    <main class="container mx-auto px-4 md:px-12 py-8 flex flex-col md:flex-row gap-8">
            ...
            <div class="mb-6">
                ...
                <div class="pl-4 flex flex-col gap-2 text-sm text-gray-600">
                    <label class="flex items-center gap-2 cursor-pointer">
                        ...
                        <span class="font-medium text-epustaka-green">Fiksi</span>
                    </label>
                    <label class="flex items-center gap-2 cursor-pointer">
        ...
        <section class="w-full md:w-3/4">
            <div class="mb-6 flex justify-between items-center">
                <h2 class="text-2xl font-bold text-gray-800">Koleksi Fiksi</h2>
