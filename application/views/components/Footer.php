...
<footer class="bg-[#004d4d] text-white pt-12 pb-8 border-t border-white/10 relative overflow-hidden">
    <div class="max-w-7xl mx-auto px-6 md:px-10">
        
        <div class="grid grid-cols-2 md:grid-cols-4 gap-x-4 gap-y-10 lg:gap-8">
            
            <?php foreach ($footerData as $title => $links): ?>
            <div class="w-fit mx-auto md:mx-0 text-left">
                <h4 class="font-bold text-xs sm:text-sm uppercase tracking-wider text-white/90 mb-4">
                    <?= $title; ?>
                </h4>
