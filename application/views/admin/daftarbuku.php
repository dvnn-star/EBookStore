        ...
        <main class="flex-1 flex flex-col">
            ...
            <header class="h-20 bg-white/80 backdrop-blur-md border-b border-slate-200/60 flex items-center justify-between px-10 sticky top-0 z-10">
                ...
                <div class="flex items-center gap-4">
                    <a href="<?= base_url('DaftarBuku/tambah_buku') ?>" class="px-5 py-2.5 text-sm font-bold text-white bg-indigo-600 rounded-xl hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-600/20 flex items-center gap-2">
                                        ...
                                        <tr class="group hover:bg-slate-50/80 transition-all">
                                            <td class="px-8 py-5">
                                                <div class="flex items-center gap-4">
                                                    ...
                                                    <div>
                                                        <p class="text-sm font-bold text-slate-800 line-clamp-1 italic"><?= $book->judul_buku ?></p>
                                                        <p class="text-[10px] text-slate-400 font-medium uppercase tracking-tight"><?= $book->penulis ?></p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="px-8 py-5 text-sm text-slate-600 font-medium"><?= $book->kategori ?></td>
                                                ...
                                                <div class="flex items-center justify-center gap-1">
                                                    <div class="flex items-center gap-2">
                                                        ...
                                                        <a href="<?= base_url('DaftarBuku/edit/' . $book->id) ?>"
                                                            class="inline-flex items-center gap-1 px-3 py-1.5 text-sm font-medium text-indigo-600 bg-indigo-50 hover:bg-indigo-100 rounded-lg transition">
