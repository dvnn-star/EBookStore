...
<body class="h-full bg-[#F8F9FA] text-[#2C3E50] antialiased">
            ...
            <section class="p-10 space-y-8">
                <div class="bg-[#FFFFFF] border border-[#2C3E50]/20 rounded-3xl shadow-md overflow-hidden">
                    <div class="px-8 py-6 border-b border-[#2C3E50]/20 bg-[#F8F9FA] flex justify-between items-center">
                        ...
                        <select onchange="filterTableLocal(this.value)" class="text-sm border-[#2C3E50]/30 rounded-lg text-[#2C3E50] font-semibold focus:ring-2 focus:ring-[#005B52]/20 focus:border-[#005B52] py-2 px-3 bg-[#FFFFFF] border shadow-sm outline-none">
                            ...
                            <tbody class="divide-y divide-[#2C3E50]/10">
                                <?php if (!empty($transactions)): ?>
                                    <?php foreach ($transactions as $tr): ?>
                                        ...
                                        <tr class="group hover:bg-[#F8F9FA] transition-all item-transaksi" data-status="<?= $statusKey ?>">
                                            <td class="px-8 py-5">
    ...
    <script>
        function filterTableLocal(statusValue) {
            const rows = document.querySelectorAll('.item-transaksi');
